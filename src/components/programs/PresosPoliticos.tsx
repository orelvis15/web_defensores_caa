        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="flex flex-col gap-4 order-1">
              <div
                className="relative rounded-2xl overflow-hidden shadow-xl ring-1 ring-black/5 bg-slate-100 cursor-zoom-in group"
              ...
              >
                ...
                {/* Indicador de zoom */}
                <div className="absolute top-4 right-4 w-9 h-9 rounded-full bg-black/40 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity z-20">
                ...
                {total > 1 && (
                  <>
                    ...
                    <button
                      ...
                      className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/85 hover:bg-white text-slate-800 shadow-md flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 z-20"
                    ...
                    <button
                      ...
                      className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-white/85 hover:bg-white text-slate-800 shadow-md flex items-center justify-center transition-all opacity-0 group-hover:opacity-100 z-20"
                    ...
                    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-2 flex-wrap justify-center max-w-[85%] z-20">
                      {images.map((_, i) => (
                        <button
                          key={i}
                          onClick={(e) => {
            ...
            <div className="order-2">
              ...
              <p className="text-muted-foreground text-base md:text-lg leading-relaxed mb-4">
                {isSpanish
                  ? "Como organización, brindamos apoyo a presos políticos cubanos y a sus familias. Acompañamos su causa con asistencia legal, humanitaria y una voz que amplifica su lucha."
                  : "As an organization, we provide support to Cuban political prisoners and their families. We stand beside their cause with legal aid, humanitarian assistance, and a voice that amplifies their struggle."}
              </p>

              <p className="text-muted-foreground text-base leading-relaxed">
                {isSpanish
                  ? "Estas son algunas de las personas a las que estamos acompañando en su lucha por la libertad y la dignidad."
                  : "These are some of the people we are standing beside in their fight for freedom and dignity."}
              </p>
