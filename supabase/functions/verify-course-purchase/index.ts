...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Session retrieved", { status: session.payment_status, sessionId });
    ...
    if (session.payment_status === "paid") {
      ...
      if (updateError) {
        console.error("[VERIFY-COURSE-PURCHASE] Update failed", updateError);
      } else {
        logStep("Course purchase marked as completed");
      }
